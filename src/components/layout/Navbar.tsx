...
import logo from "../../../public/IAC Company Logo Main.png";
...
const practiceAreas = [
  ...
  { label: "Ifeanyi Anago & Partners", href: "/practice-areas/ifeanyi-anago-partners" },
];
...
const services = [
  ...
  { label: "Ifeanyi Anago & Partners", href: "/services/ifeanyi-anago-partners" },
];
...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-[1280px] mx-auto px-5 md:px-10 lg:px-20" ref={navRef}>
                        ...
                        {link.dropdown.map((item) => (
                          <Link
                            ...
                            className={`flex items-center gap-2 px-5 py-3 font-inter text-sm text-charcoal hover:text-iac-gold hover:bg-parchment-gold transition-colors duration-150 group ${
                              item.label === "Ifeanyi Anago & Partners"
                                ? "border-t border-fog mt-1"
                                : ""
                            }`}
                        ...
                        {link.dropdown.map((item) => (
                          <Link
                            ...
                            className={`block py-3 font-inter text-base text-champagne border-b border-white/5 hover:text-white transition-colors ${
                              item.label === "Ifeanyi Anago & Partners"
                                ? "text-brass hover:text-champagne"
                                : ""
                            }`}
                            onClick={() => setMobileOpen(false)}
                          >
